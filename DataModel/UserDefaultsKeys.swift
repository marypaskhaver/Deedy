...
class UserDefaultsKeys {
    ...
    static let navBarTextColor = "navBarTextColor"
    
    static let redSliderValue = "redSliderValue"
    static let greenSliderValue = "greenSliderValue"
    static let blueSliderValue = "blueSliderValue"
